...
import com.example.githubuser_dicoding.databinding.FragmentFollowingBinding
...
class FollowingFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        detailViewModel.findListFollowing(getLogin)
        detailViewModel.findListFollowing.observe(viewLifecycleOwner) { Responseitem ->
    ...
    fun showRecycler(value: List<ResponseItem>) {
        ...
        binding.idrecyclerviewFollowing.apply {
